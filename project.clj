(defproject djtest "0.1.0-SNAPSHOT"
  ...
  :aliases {"descjop-help" ["new" "descjop" "help"]
            ...
            "descjop-uberapp-osx" ["shell" "electron-packager" "./app/prod" "djtest" "--platform=darwin" "--arch=x64" "--electron-version=1.6.6"]
            "descjop-uberapp-app-store" ["shell" "electron-packager" "./app/prod" "djtest" "--platform=mas" "--arch=x64" "--electron-version=1.6.6"]
            "descjop-uberapp-linux" ["shell" "electron-packager" "./app/prod" "djtest" "--platform=linux" "--arch=x64" "--electron-version=1.6.6"]
            "descjop-uberapp-win64" ["shell" "cmd.exe" "/c" "electron-packager" "./app/prod" "djtest" "--platform=win32" "--arch=x64" "--electron-version=1.6.6"]
            "descjop-uberapp-win32" ["shell" "cmd.exe" "/c" "electron-packager" "./app/prod" "djtest" "--platform=win32" "--arch=ia32" "--electron-version=1.6.6"]
            }
  ...
  {:builds
   {:dev-main {:source-paths ["src"]
               ...
               :compiler {:output-to "app/dev/js/cljsbuild-main.js"
                          ...
                          :pretty-print true
                          :output-wrapper true}}
    :dev-front {:source-paths ["src_front" "src_front_profile/djtest_front/dev"]
                :incremental true
                :jar true
                :assert true
    ...
    :prod-main {:source-paths ["src"]
                ...
                :compiler {:output-to "app/prod/js/cljsbuild-main.js"
                           ...
                           :pretty-print true
                           :output-wrapper true}}
    :prod-front {:source-paths ["src_front" "src_front_profile/djtest_front/prod"]
                 :incremental true
                 :jar true
                 :assert true
