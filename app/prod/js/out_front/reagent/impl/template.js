...
var G__12541 = o;
(G__12541[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__12549 = jsprops;
(G__12549["defaultValue"] = value);

(G__12549["onChange"] = ((function (G__12549,v,value,on_change){
return (function (p1__12547_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12547_SHARP_);
});})(G__12549,v,value,on_change))
);
...
var vec__12556 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12556,(0),null);
var id = cljs.core.nth.call(null,vec__12556,(1),null);
var class$ = cljs.core.nth.call(null,vec__12556,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___12561 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___12561 == null)){
} else {
var key_12562 = temp__4661__auto___12561;
(jsprops["key"] = key_12562);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12564 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__12564["name"] = c);
...
var len__7923__auto___12569 = arguments.length;
var i__7924__auto___12570 = (0);
while(true){
if((i__7924__auto___12570 < len__7923__auto___12569)){
args__7930__auto__.push((arguments[i__7924__auto___12570]));

var G__12571 = (i__7924__auto___12570 + (1));
i__7924__auto___12570 = G__12571;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12567){
var G__12568 = cljs.core.first.call(null,seq12567);
var seq12567__$1 = cljs.core.next.call(null,seq12567);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12568,seq12567__$1);
});
...
break;
default:
var G__12575 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__12575;
continue;
...
var n__7737__auto___12578 = a.length;
var i_12579 = (0);
while(true){
if((i_12579 < n__7737__auto___12578)){
(a[i_12579] = reagent.impl.template.as_element.call(null,(a[i_12579])));
...
var a = cljs.core.into_array.call(null,s);
var n__7737__auto___12581 = a.length;
var i_12582 = (0);
while(true){
if((i_12582 < n__7737__auto___12581)){
var val_12583 = (a[i_12582]);
if((cljs.core.vector_QMARK_.call(null,val_12583)) && ((reagent.impl.template.key_from_vec.call(null,val_12583) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12582] = reagent.impl.template.as_element.call(null,val_12583));

var G__12584 = (i_12582 + (1));
i_12582 = G__12584;
continue;
} else {
}
...
var ctx = ({});
var vec__12588 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__12588,(0),null);
var derefed = cljs.core.nth.call(null,vec__12588,(1),null);
...
var G__12592 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12592) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__12592){
