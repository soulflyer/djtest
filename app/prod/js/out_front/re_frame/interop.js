...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__12859 = cljs.core.instance_QMARK_;
var expr__12860 = reactive_val;
if(cljs.core.truth_(pred__12859.call(null,reagent.ratom.RAtom,expr__12860))){
return "ra";
} else {
if(cljs.core.truth_(pred__12859.call(null,reagent.ratom.RCursor,expr__12860))){
return "rc";
} else {
if(cljs.core.truth_(pred__12859.call(null,reagent.ratom.Reaction,expr__12860))){
return "rx";
} else {
if(cljs.core.truth_(pred__12859.call(null,reagent.ratom.Track,expr__12860))){
return "tr";
} else {
return "other";
}
