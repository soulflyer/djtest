...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__22038){
var vec__22042 = p__22038;
var k = cljs.core.nth.call(null,vec__22042,(0),null);
var v = cljs.core.nth.call(null,vec__22042,(1),null);
...
var args22045 = [];
var len__8057__auto___22048 = arguments.length;
var i__8058__auto___22049 = (0);
while(true){
if((i__8058__auto___22049 < len__8057__auto___22048)){
args22045.push((arguments[i__8058__auto___22049]));

var G__22050 = (i__8058__auto___22049 + (1));
i__8058__auto___22049 = G__22050;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args22045.length)].join('')));
...
var vec_key_encode = (function (){var G__22053 = ((((function (){var or__6948__auto__ = vec_strategy;
...
var args22055 = [];
var len__8057__auto___22070 = arguments.length;
var i__8058__auto___22071 = (0);
while(true){
if((i__8058__auto___22071 < len__8057__auto___22070)){
args22055.push((arguments[i__8058__auto___22071]));

var G__22072 = (i__8058__auto___22071 + (1));
i__8058__auto___22071 = G__22072;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args22055.length)].join('')));

}
});

ajax.url.param_to_key_value_pairs.cljs$core$IFn$_invoke$arity$3 = (function (vec_key_transform,prefix,p__22058){
var vec__22059 = p__22058;
var key = cljs.core.nth.call(null,vec__22059,(0),null);
var value = cljs.core.nth.call(null,vec__22059,(1),null);
...
var key = cljs.core.nth.call(null,vec__22063,(0),null);
var value = cljs.core.nth.call(null,vec__22063,(1),null);
...
return (function (prefix,p__22066){
var vec__22067 = p__22066;
var key = cljs.core.nth.call(null,vec__22067,(0),null);
var value = cljs.core.nth.call(null,vec__22067,(1),null);
...
var args22074 = [];
var len__8057__auto___22077 = arguments.length;
var i__8058__auto___22078 = (0);
while(true){
if((i__8058__auto___22078 < len__8057__auto___22077)){
args22074.push((arguments[i__8058__auto___22078]));

var G__22079 = (i__8058__auto___22078 + (1));
i__8058__auto___22078 = G__22079;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args22074.length)].join('')));
...
var args22081 = [];
var len__8057__auto___22087 = arguments.length;
var i__8058__auto___22088 = (0);
while(true){
if((i__8058__auto___22088 < len__8057__auto___22087)){
args22081.push((arguments[i__8058__auto___22088]));

var G__22089 = (i__8058__auto___22088 + (1));
i__8058__auto___22088 = G__22089;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args22081.length)].join('')));
...
ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__22084){
var map__22085 = p__22084;
var map__22085__$1 = ((((!((map__22085 == null)))?((((map__22085.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22085.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22085):map__22085);
var vec_strategy = cljs.core.get.call(null,map__22085__$1,new cljs.core.Keyword(null,"vec-strategy","vec-strategy",1843221372));
