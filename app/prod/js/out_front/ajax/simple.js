...
var args22503 = [];
var len__8057__auto___22506 = arguments.length;
var i__8058__auto___22507 = (0);
while(true){
if((i__8058__auto___22507 < len__8057__auto___22506)){
args22503.push((arguments[i__8058__auto___22507]));

var G__22508 = (i__8058__auto___22507 + (1));
i__8058__auto___22507 = G__22508;
continue;
} else {
}
break;
...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__22510){
var map__22513 = p__22510;
...
var handler = cljs.core.get.call(null,map__22513__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
...
return cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__6948__auto__ = p1__22515_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__22516){
...
var interceptors = cljs.core.get.call(null,map__22519__$1,new cljs.core.Keyword(null,"interceptors","interceptors",-1546782951));
