...
var args22523 = [];
var len__8057__auto___22526 = arguments.length;
var i__8058__auto___22527 = (0);
while(true){
if((i__8058__auto___22527 < len__8057__auto___22526)){
args22523.push((arguments[i__8058__auto___22527]));

var G__22528 = (i__8058__auto___22527 + (1));
i__8058__auto___22527 = G__22528;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args22523.length)].join('')));
...
var G__22531 = (((format instanceof cljs.core.Keyword))?format.fqn:null);
switch (G__22531) {
case "transit":
return ajax.transit.transit_request_format.call(null,format_params);
...
var G__22534 = (((format instanceof cljs.core.Keyword))?format.fqn:null);
switch (G__22534) {
case "transit":
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__22536_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__22536_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__22537){
var map__22547 = p__22537;
var map__22547__$1 = ((((!((map__22547 == null)))?((((map__22547.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__22547.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__22547):map__22547);
var handler = cljs.core.get.call(null,map__22547__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__22547__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__22547__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return ((function (h,e,map__22547,map__22547__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__22549){
var vec__22553 = p__22549;
var ok = cljs.core.nth.call(null,vec__22553,(0),null);
var result = cljs.core.nth.call(null,vec__22553,(1),null);
...
;})(h,e,map__22547,map__22547__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__22556){
var map__22559 = p__22556;
...
var method = cljs.core.get.call(null,map__22559__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__22559__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__22559__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__22559__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__22559__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
