...
var or__45121__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj46397 = {"detail":data};
return obj46397;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__45109__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__45109__auto__)){
var and__45109__auto____$1 = (window["CustomEvent"]);
...
var args46402 = [];
var len__46230__auto___46408 = arguments.length;
var i__46231__auto___46409 = (0);
while(true){
if((i__46231__auto___46409 < len__46230__auto___46408)){
args46402.push((arguments[i__46231__auto___46409]));

var G__46410 = (i__46231__auto___46409 + (1));
i__46231__auto___46409 = G__46410;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args46402.length)].join('')));
...
var f = (function (){var pred__46405 = cljs.core._EQ_;
var expr__46406 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__46405.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__46406))){
return ((function (pred__46405,expr__46406){
return (function (p1__46398_SHARP_){
return console.warn(p1__46398_SHARP_);
});
;})(pred__46405,expr__46406))
} else {
if(cljs.core.truth_(pred__46405.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__46406))){
return ((function (pred__46405,expr__46406){
return (function (p1__46399_SHARP_){
return console.debug(p1__46399_SHARP_);
});
;})(pred__46405,expr__46406))
} else {
if(cljs.core.truth_(pred__46405.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__46406))){
return ((function (pred__46405,expr__46406){
return (function (p1__46400_SHARP_){
return console.error(p1__46400_SHARP_);
});
;})(pred__46405,expr__46406))
} else {
return ((function (pred__46405,expr__46406){
return (function (p1__46401_SHARP_){
return console.log(p1__46401_SHARP_);
});
;})(pred__46405,expr__46406))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__46412){
var map__46415 = p__46412;
...
var opts = map__46415__$1;
var eval_fn = cljs.core.get.call(null,map__46415__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return (function (p1__46417_SHARP_){
return new_def.callback(p1__46417_SHARP_);
});})(new_def))
);
...
return (function (p__46418){
var vec__46419 = p__46418;
var ky = cljs.core.nth.call(null,vec__46419,(0),null);
var v = cljs.core.nth.call(null,vec__46419,(1),null);
...
var args46422 = [];
var len__46230__auto___46425 = arguments.length;
var i__46231__auto___46426 = (0);
while(true){
if((i__46231__auto___46426 < len__46230__auto___46425)){
args46422.push((arguments[i__46231__auto___46426]));

var G__46427 = (i__46231__auto___46426 + (1));
i__46231__auto___46426 = G__46427;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args46422.length)].join('')));
...
if(cljs.core.truth_((function (){var and__45109__auto__ = typeof localStorage !== 'undefined';
