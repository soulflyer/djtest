...
var args9911 = [];
var len__8057__auto___9914 = arguments.length;
var i__8058__auto___9915 = (0);
while(true){
if((i__8058__auto___9915 < len__8057__auto___9914)){
args9911.push((arguments[i__8058__auto___9915]));

var G__9916 = (i__8058__auto___9915 + (1));
i__8058__auto___9915 = G__9916;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args9911.length)].join('')));
...
var G__9919 = (((format instanceof cljs.core.Keyword))?format.fqn:null);
switch (G__9919) {
case "transit":
return ajax.transit.transit_request_format.call(null,format_params);
...
var G__9922 = (((format instanceof cljs.core.Keyword))?format.fqn:null);
switch (G__9922) {
case "transit":
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__9924_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__9924_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__9925){
var map__9935 = p__9925;
...
var handler = cljs.core.get.call(null,map__9935__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__9935__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__9935__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return ((function (h,e,map__9935,map__9935__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__9937){
var vec__9941 = p__9937;
var ok = cljs.core.nth.call(null,vec__9941,(0),null);
var result = cljs.core.nth.call(null,vec__9941,(1),null);
...
;})(h,e,map__9935,map__9935__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__9944){
var map__9947 = p__9944;
var map__9947__$1 = ((((!((map__9947 == null)))?((((map__9947.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9947.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9947):map__9947);
var opts = map__9947__$1;
var method = cljs.core.get.call(null,map__9947__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__9947__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__9947__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__9947__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__9947__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
