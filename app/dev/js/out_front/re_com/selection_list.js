...
var args11030 = [];
var len__7923__auto___11033 = arguments.length;
var i__7924__auto___11034 = (0);
while(true){
if((i__7924__auto___11034 < len__7923__auto___11033)){
args11030.push((arguments[i__7924__auto___11034]));

var G__11035 = (i__7924__auto___11034 + (1));
i__7924__auto___11034 = G__11035;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args11030.length)].join('')));
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__11040){
var map__11043 = p__11040;
...
var args = map__11043__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__11043__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__11043__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var item_renderer = cljs.core.get.call(null,map__11043__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__11043__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__11043__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__11043__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__11043__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var hide_border_QMARK_ = cljs.core.get.call(null,map__11043__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var choices = cljs.core.get.call(null,map__11043__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__11043__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__11043__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__11043,map__11043__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__11037_SHARP_){
return item_renderer.call(null,p1__11037_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__11043,map__11043__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__11043,map__11043__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__11038_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__11038_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__11043,map__11043__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__11043,map__11043__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_){
return (function (p1__11039_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__11039_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__11043,map__11043__$1,args,disabled_QMARK_,on_change,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,hide_border_QMARK_,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__7923__auto___11052 = arguments.length;
var i__7924__auto___11053 = (0);
while(true){
if((i__7924__auto___11053 < len__7923__auto___11052)){
args__7930__auto__.push((arguments[i__7924__auto___11053]));

var G__11054 = (i__7924__auto___11053 + (1));
i__7924__auto___11053 = G__11054;
continue;
} else {
}
break;
...
re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__11046){
...
var args = map__11047__$1;

return ((function (map__11047,map__11047__$1,args){
return (function() { 
var G__11055__delegate = function (p__11049){
var map__11050 = p__11049;
var map__11050__$1 = ((((!((map__11050 == null)))?((((map__11050.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__11050.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__11050):map__11050);
var args__$1 = map__11050__$1;
...
while (G__11056__i < G__11056__a.length) {G__11056__a[G__11056__i] = arguments[G__11056__i + 0]; ++G__11056__i;}
  p__11049 = new cljs.core.IndexedSeq(G__11056__a,0);
} 
return G__11055__delegate.call(this,p__11049);};
G__11055.cljs$lang$maxFixedArity = 0;
G__11055.cljs$lang$applyTo = (function (arglist__11057){
var p__11049 = cljs.core.seq(arglist__11057);
return G__11055__delegate(p__11049);
});
G__11055.cljs$core$IFn$_invoke$arity$variadic = G__11055__delegate;
return G__11055;
})()
;
;})(map__11047,map__11047__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq11045){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq11045));
});
