...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__45732__auto__,writer__45733__auto__,opt__45734__auto__){
return cljs.core._write.call(null,writer__45733__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__46642 = o;
(G__46642[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__45109__auto__ = !((jsprops == null));
if(and__45109__auto__){
var and__45109__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__45109__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__45109__auto____$1;
}
} else {
...
var G__46650 = jsprops;
(G__46650["defaultValue"] = value);

(G__46650["onChange"] = ((function (G__46650,v,value,on_change){
return (function (p1__46648_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__46648_SHARP_);
});})(G__46650,v,value,on_change))
);
...
var vec__46657 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__46657,(0),null);
var id = cljs.core.nth.call(null,vec__46657,(1),null);
var class$ = cljs.core.nth.call(null,vec__46657,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___46662 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___46662 == null)){
} else {
var key_46663 = temp__4661__auto___46662;
(jsprops["key"] = key_46663);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__46665 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__46665["name"] = c);
...
var len__46230__auto___46670 = arguments.length;
var i__46231__auto___46671 = (0);
while(true){
if((i__46231__auto___46671 < len__46230__auto___46670)){
args__46237__auto__.push((arguments[i__46231__auto___46671]));

var G__46672 = (i__46231__auto___46671 + (1));
i__46231__auto___46671 = G__46672;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__46238__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq46668){
var G__46669 = cljs.core.first.call(null,seq46668);
var seq46668__$1 = cljs.core.next.call(null,seq46668);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__46669,seq46668__$1);
});
...
break;
default:
var G__46676 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__46676;
continue;
...
var n__46044__auto___46679 = a.length;
var i_46680 = (0);
while(true){
if((i_46680 < n__46044__auto___46679)){
(a[i_46680] = reagent.impl.template.as_element.call(null,(a[i_46680])));

var G__46681 = (i_46680 + (1));
i_46680 = G__46681;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__46044__auto___46682 = a.length;
var i_46683 = (0);
while(true){
if((i_46683 < n__46044__auto___46682)){
var val_46684 = (a[i_46683]);
if((cljs.core.vector_QMARK_.call(null,val_46684)) && ((reagent.impl.template.key_from_vec.call(null,val_46684) == null))){
(o["no-key"] = true);
} else {
}

(a[i_46683] = reagent.impl.template.as_element.call(null,val_46684));

var G__46685 = (i_46683 + (1));
i_46683 = G__46685;
continue;
} else {
}
...
var ctx = ({});
var vec__46689 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__46689,(0),null);
var derefed = cljs.core.nth.call(null,vec__46689,(1),null);
...
var G__46693 = (cljs.core.count.call(null,argv) - first_child);
switch (G__46693) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__46693){
