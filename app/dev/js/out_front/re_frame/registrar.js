...
var args47338 = [];
var len__46527__auto___47341 = arguments.length;
var i__46528__auto___47342 = (0);
while(true){
if((i__46528__auto___47342 < len__46527__auto___47341)){
args47338.push((arguments[i__46528__auto___47342]));

var G__47343 = (i__46528__auto___47342 + (1));
i__46528__auto___47342 = G__47343;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args47338.length)].join('')));
...
if(cljs.core.truth_((function (){var and__45406__auto__ = required_QMARK_;
if(cljs.core.truth_(and__45406__auto__)){
return (handler == null);
} else {
...
var args47345 = [];
var len__46527__auto___47348 = arguments.length;
var i__46528__auto___47349 = (0);
while(true){
if((i__46528__auto___47349 < len__46527__auto___47348)){
args47345.push((arguments[i__46528__auto___47349]));

var G__47350 = (i__46528__auto___47349 + (1));
i__46528__auto___47349 = G__47350;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args47345.length)].join('')));
