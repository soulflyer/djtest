...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__47058 = cljs.core.instance_QMARK_;
var expr__47059 = reactive_val;
if(cljs.core.truth_(pred__47058.call(null,reagent.ratom.RAtom,expr__47059))){
return "ra";
} else {
if(cljs.core.truth_(pred__47058.call(null,reagent.ratom.RCursor,expr__47059))){
return "rc";
} else {
if(cljs.core.truth_(pred__47058.call(null,reagent.ratom.Reaction,expr__47059))){
return "rx";
} else {
if(cljs.core.truth_(pred__47058.call(null,reagent.ratom.Track,expr__47059))){
return "tr";
} else {
return "other";
}
