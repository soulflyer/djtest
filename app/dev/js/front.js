...
goog.addDependency("../djtest/config.js", ['djtest.config'], ['cljs.core']);
goog.addDependency("../djtest/db.js", ['djtest.db'], ['cljs.core']);
...
goog.addDependency("../djtest/events.js", ['djtest.events'], ['ajax.core', 'cljs.core', 'djtest.config', 'djtest.db', 're_frame.core', 'day8.re_frame.http_fx']);
...
goog.addDependency("../djtest/subs.js", ['djtest.subs'], ['cljs.core', 're_frame.core']);
goog.addDependency("../djtest/views.js", ['djtest.views'], ['re_com.core', 'cljs.core', 'djtest.subs', 're_frame.core']);
goog.addDependency("../djtest/core.js", ['djtest.core'], ['reagent.core', 'cljs.core', 'djtest.events', 'djtest.views', 'djtest.config', 're_frame.core']);
...
goog.addDependency("../djtest/conf.js", ['djtest.conf'], ['cljs.core']);
goog.addDependency("../djtest_front/init.js", ['djtest_front.init'], ['djtest.core', 'cljs.core', 'figwheel.client', 'djtest.conf']);
